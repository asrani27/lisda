...
<div class="col-sm-12">
    <div class="card">
        ...
        <div class="card-body">
            <form method="post" action="/superadmin/rumah/edit/{{$data->id}}">
                <div class="row">
                    @csrf
                    <div class="col-sm-12">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="luas_bangunan" name="luas_bangunan"
                                required value="{{$data->luas_bangunan}}">
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="harga cash" name="harga_cash" required
                                onkeypress="return hanyaAngka(event)" value="{{$data->harga_cash}}">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="Uang muka pesan" name="uang_muka_pesan"
                                required onkeypress="return hanyaAngka(event)" value="{{$data->uang_muka_pesan}}">
                        </div>
                        <div class="form-group">
